...
export interface SahneFiguru {
  ...
  elde?: string | null;
  /**
   * TERS KİNEMATİK EL HEDEFİ
   * Figürün kendi ekseninde nokta: [sağa, yukarı, ileri] metre.
   * Örn. örse vuran demirci sağ eli: [0.34, 0.92, 0.55]
   */
...
export interface EtkinlikSahnesi {
  ...
  /**
   * ORTAK BAKIŞ ODAĞI
   * Sahnedeki herkesin başı buraya döner. Merkeze göre göreli,
   * tasarım birimi: [dx, yükseklik, dz].
   * Ancient Egypt'in "hepsi bir bütünün parçası" hissi buradan gelir.
   */
  odak?: [number, number, number];
...
export const SAHNELER: EtkinlikSahnesi[] = [
     ...
     Usta örsün TAM YANINDA, örse dönük. Yardımcı körükte. */
  {
    ...
    merkez: [-26, 6],
    nesne: "P02",
    odak: [1.5, 0.95, 0.2],          // örsün üstü — herkes oraya bakar
    figurler: [
      { id: "sd_usta", aktivite: "demirci", dx: 1.9, dz: 0.2, yon: Math.PI * 1.5, elde: "cekic",
        // sağ el örsün üstünde, sol el maşayla işi tutuyor
        elHedefi: { sag: [-0.25, 1.08, 0.25], sol: [0.25, 1.06, 0.21] } },
     ...
     Usta çarkın TAM BAŞINDA, oturmuş. */
  {
    ...
    figurler: [
      { id: "sc_usta", aktivite: "comlekci", dx: 0.0, dz: 1.1, yon: Math.PI,
        // iki el çarkın üstündeki kabın çevresinde
        elHedefi: { sag: [-0.25, 1.10, 0.29], sol: [0.25, 1.10, 0.29] } },
  ...
  /* ---------- DOKUMA TEZGÂHI ---------- */
  {
    ...
    figurler: [
      { id: "sdk_usta", aktivite: "dokumaci", dx: 0.0, dz: 1.0, yon: Math.PI,
        // eller tezgâhın çözgü hizasında
        elHedefi: { sag: [-0.25, 1.26, 0.33], sol: [0.25, 1.26, 0.33] } },
  ...
  /* ---------- OK YAPIM TEZGÂHI ---------- */
  {
    ...
    figurler: [
      { id: "soy_usta", aktivite: "okYapan", dx: 0.0, dz: 1.0, yon: Math.PI, elde: "ok",
        elHedefi: { sag: [-0.24, 1.14, 0.28], sol: [0.24, 1.12, 0.26] } },
  ...
  /* ---------- DERİ GERDİRME ---------- */
  {
    ...
    figurler: [
      { id: "sdr_usta", aktivite: "deriGeren", dx: 0.0, dz: 1.2, yon: Math.PI,
        // iki el gerdirme çerçevesinin üst çubuğunda
        elHedefi: { sag: [-0.25, 1.56, 0.29], sol: [0.25, 1.56, 0.29] } },
  ...
  /* ---------- OCAK BAŞI / AŞÇI ---------- */
  {
    ...
    figurler: [
      { id: "sob_asci", aktivite: "asci", dx: 1.4, dz: 0.6, yon: Math.PI * 1.55, elde: "kepce",
        // sağ el kazanın üstünde karıştırıyor
        elHedefi: { sag: [-0.25, 1.12, 0.29] } },
  ...
  /* ---------- İP BÜKME (konum düzeltildi) ---------- */
  {
    ...
    figurler: [
      { id: "sib_usta", aktivite: "ipBuken", dx: 0, dz: 1.0, yon: Math.PI,
        elHedefi: { sag: [-0.22, 1.02, 0.24], sol: [0.24, 1.18, 0.18] } },
