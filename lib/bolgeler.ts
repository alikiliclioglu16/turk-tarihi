...
export const BOLGELER: Record<BolgeId, Bolge> = {
  oba: {
    ...
    sisRenk: "#C8CBB8", sisYogunluk: 0.0016,
    ortamRenk: "#2c3d63", ortamGuc: 0.35, ayGuc: 0.6,
    gokUst: "#050a16", gokUfuk: "#2a3f6a",
  },
  pazaryeri: {
    id: "pazaryeri", ad: "Pazaryeri", merkez: [46, -34], yaricap: 34, duygu: "canlı",
    sisRenk: "#CFC7AE", sisYogunluk: 0.0014,
  ...
  su_basi: {
    ...
    sisRenk: "#BFCBC4", sisYogunluk: 0.0022,
  ...
  eski_yurt: {
    ...
    sisRenk: "#CCC6B4", sisYogunluk: 0.0026,
