...
const HALK_ANA: HalkKaydi[] = [
  ...
  { id: "h_demirci_yamak", aktivite: "comlekci", pos: [-24, 10.5], yon: 4.2, renk: "#B9A688", boy: 1.5 },
  {
  ...
  { id: "h_egitmen", aktivite: "dokumaci", pos: [17, -16], yon: 0.2, renk: "#C9B896", kusak: "#A8382F" },
  ...
  { id: "h_atterbiye_2", aktivite: "asci", pos: [26.5, -26], yon: 3.14, renk: "#BDAB8C", kusak: "#5A3D20" },
...
export const OBA_DOLGU: HalkKaydi[] = [
  ...
  { id: "hd_01", aktivite: "dokumaci", pos: [-15.6, 18.4], yon: 3.15, renk: "#D8C4A0", kusak: "#4BB3A9", boy: 1.61, },
  ...
  { id: "hd_11", aktivite: "dokumaci", pos: [-3.6, 2.9], yon: 3.26, renk: "#CDBB98", kusak: "#4A6B6B", boy: 1.71, },
  ...
  { id: "hd_21", aktivite: "dokumaci", pos: [10.7, -14.8], yon: 1.54, renk: "#C4B292", kusak: "#6B5636", boy: 1.63, rota: [[10.7,-14.8],[18.7,-9.8],[14.7,-2.8],[6.7,-8.8]], },
  ...
  { id: "hd_30", aktivite: "okYapan", pos: [-20.6, 18.5], yon: 2.43, renk: "#DCCBA6", kusak: "#A8382F", boy: 1.76, },
...
export const ORDUGAH_HALKI: HalkKaydi[] = [
  ...
  { id: "or_28", aktivite: "asker", pos: [10.1, -57.0], yon: 5.37, renk: "#A99A7E", kusak: "#5A3D20", boy: 1.81, rota: [[10.1,-57.0],[19.1,-54.0],[15.1,-46.0],[6.1,-51.0]], },
